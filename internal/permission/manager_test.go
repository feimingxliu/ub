...
func execReq(t *testing.T, mode execmode.Mode, command string) Request {
	t.Helper()
	return Request{
		Tool: "bash",
...
func networkReq(t *testing.T, mode execmode.Mode, toolName string, args map[string]any) Request {
	t.Helper()
...
func TestManagerHumanDecisionPaths(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			req := execReq(t, execmode.ModeWork, "git status")
...
func TestManagerPlanRejectsExecWithoutAsker(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModePlan, "git status"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
	if res.Allowed || res.Decision != DecisionDeny || res.Source != SourceMode {
...
func TestManagerPlanRejectsNetworkWithoutAsker(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), networkReq(t, execmode.ModePlan, "web_fetch", map[string]any{
...
func TestManagerDefaultExecUsesHumanAsker(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeWork, "git status"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
...
func TestManagerDefaultNetworkUsesHumanAsker(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), networkReq(t, execmode.ModeWork, "web_fetch", map[string]any{
...
func TestManagerFullAccessAllowsExecWithoutHumanOrAgent(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeFullAccess, "git status"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
...
func TestManagerFullAccessStillHonorsDenyAndAskRules(t *testing.T) {
	t.Run("deny rule", func(t *testing.T) {
		...
		res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeFullAccess, "git push origin main"))
		if err != nil {
			t.Fatalf("Ask: %v", err)
		}
...
func TestManagerFullAccessDoesNotBypassBlacklist(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeFullAccess, "rm -rf /"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
	if !res.Allowed || res.Source != SourceHuman {
...
func TestManagerAgentApproveAllowSkipsHuman(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeAuto, "git status"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
...
func TestManagerNetworkRulesUseWebTargets(t *testing.T) {
	...
	t.Run("web_search domain", func(t *testing.T) {
		...
		res, err := manager.Ask(context.Background(), networkReq(t, execmode.ModeWork, "web_search", map[string]any{
			"query":   "release notes",
...
func TestManagerLogsApprovalAgentDecision(t *testing.T) {
	...
	if _, err := manager.Ask(context.Background(), execReq(t, execmode.ModeAuto, "git status")); err != nil {
		t.Fatalf("Ask: %v", err)
	}
	got := logs.String()
...
func TestManagerSessionRules(t *testing.T) {
	t.Run("always command matches exact command", func(t *testing.T) {
		...
		if _, err := manager.Ask(context.Background(), execReq(t, execmode.ModeWork, "git status")); err != nil {
	...
	t.Run("always tool matches different commands", func(t *testing.T) {
		...
		asker.decision = DecisionDeny
		res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeWork, "go test ./..."))
		if err != nil {
			t.Fatalf("second Ask: %v", err)
		}
		if !res.Allowed || res.Source != SourceRule {
...
func TestManagerBlacklistBypassesAllowRule(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeWork, "rm -rf /"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
	if !res.Allowed || res.Source != SourceHuman {
...
func TestManagerBlacklistBypassesApprovalAgent(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeAuto, "dd if=file of=/dev/sda"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
	if !res.Allowed || res.Source != SourceHuman {
...
func TestManagerAlwaysProjectCommandAcrossManagers(t *testing.T) {
	...
	res, err := nextManager.Ask(context.Background(), execReq(t, execmode.ModeWork, "git status"))
	if err != nil {
	...
	res, err = nextManager.Ask(context.Background(), execReq(t, execmode.ModeWork, "go test ./..."))
	if err != nil {
...
func TestManagerAlwaysProjectPatternAcrossManagers(t *testing.T) {
	...
	req := execReq(t, execmode.ModeWork, "go test ./internal/permission")
	req.Workspace = workspace
	if _, err := manager.Ask(context.Background(), req); err != nil {
		t.Fatalf("Ask: %v", err)
	}
	...
	res, err := nextManager.Ask(context.Background(), execReq(t, execmode.ModeWork, "go test ./internal/tui"))
	if err != nil {
	...
	res, err = nextManager.Ask(context.Background(), execReq(t, execmode.ModeWork, "go build ./cmd/ub"))
	if err != nil {
		t.Fatalf("Ask next different: %v", err)
	}
	if res.Allowed || res.Source != SourceHuman {
...
func TestManagerCommandPatternDoesNotCoverCompoundCommand(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeWork, "git status && rm -rf ./build"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
	if res.Allowed || res.Source != SourceHuman {
...
func TestManagerCommandPatternCoversCompoundWhenEachSubcommandMatches(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeWork, "git status && go test ./..."))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
	if !res.Allowed || res.Source != SourceRule {
...
func TestManagerDenyRuleBlocksBeforeHumanOrAgent(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeAuto, "curl https://example.test"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
	if res.Allowed || res.Source != SourceRule || res.Decision != DecisionDeny {
...
func TestManagerAskRuleForcesHumanInAutoMode(t *testing.T) {
	...
	res, err := manager.Ask(context.Background(), execReq(t, execmode.ModeAuto, "git push origin main"))
	if err != nil {
		t.Fatalf("Ask: %v", err)
	}
	if !res.Allowed || res.Source != SourceHuman {
