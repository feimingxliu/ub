...
| V2（深化） | `roadmap-v2.md` | 已落地：ask、task、memory、plan artifact、todo、multiedit、tool streaming、扩展 LSP、tool_result、web_search/web_fetch、模型发起 plan mode、full-access、goal mode、prompt section registry、上下文窗口 resolver 等；当前主线：ContextDecision/语义裁剪、provider prefix cache、事件总线/tracing、eval |
