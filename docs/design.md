...
| V2 深化 | — | `roadmap-v2.md` | 已落地 ask、task、memory、plan/todo、multiedit、tool streaming、扩展 LSP、tool_result、web 工具、模型发起 plan mode、full-access、goal mode；当前主线是上下文窗口预测、压缩策略、prompt builder 分层、provider prefix cache、事件总线/tracing 和 eval |
