...
│   │   ├── fs/                        # read / write / edit / multiedit / ls
│   │   ├── search/                    # grep / glob
│   │   ├── shell/                     # bash
