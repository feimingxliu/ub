# anthropic-streaming Specification

## Purpose

Define Anthropic streaming Messages API behavior, delta conversion, usage/done termination, cancellation, and close semantics.
